...
// render init block
const myChart = new Chart(document.getElementById("Total_Bar_Chart"), config);

const percentage = [70, 30];
const data1 = {
  labels: ["Succesful", "Failed"],
  datasets: [
    {
      label: "Order Statistics",
      data: percentage,
      backgroundColor: ["rgba(52, 181, 58, 1)", "rgba(220, 53, 53, 1)"],
      borderWidth: 0,
    },
  ],
};
...
const month = [
  { month: "Oct", dateMonth: ["Nov 1", "Nov 5", "Nov 10", "Nov 15", "Nov 20"] },
...
gradient.addColorStop(
  0,
  "rgba(151, 71, 255, 0.50)",
  "rgba(217, 217, 217, 0.00)"
); // Bắt đầu với một màu nhạt
