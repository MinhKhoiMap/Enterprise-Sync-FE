...
let sampleData = [
  { orderId: 1, orderDay: "2022-03-01", chanel: "Shopee", totalPrice: 150, status: "Done" },
  { orderId: 2, orderDay: "2022-03-02", chanel: "Tiki", totalPrice: 150, status: "Done" },
  { orderId: 3, orderDay: "2022-03-03", chanel: "TikTokShop", totalPrice: 100, status: "Pending" },
  { orderId: 4, orderDay: "2022-03-03", chanel: "Lazada", totalPrice: 100, status: "Return" },
  { orderId: 5, orderDay: "2022-03-03", chanel: "Tiki", totalPrice: 100, status: "Done" },
  { orderId: 6, orderDay: "2022-03-03", chanel: "Sendo", totalPrice: 100, status: "Done" },
  { orderId: 7, orderDay: "2022-03-03", chanel: "Sendo", totalPrice: 100, status: "Done" },
  { orderId: 8, orderDay: "2022-03-03", chanel: "Sendo", totalPrice: 100, status: "Done" },
  { orderId: 9, orderDay: "2022-03-03", chanel: "Sendo", totalPrice: 100, status: "Done" },
  { orderId: 10, orderDay: "2022-03-03", chanel: "Sendo", totalPrice: 100, status: "Done" },
  { orderId: 11, orderDay: "2022-03-03", chanel: "Sendo", totalPrice: 100, status: "Done" }
];
...
axios.get(apiUrl)
  .then(response => {
    ...
    response.data.forEach(order => {
      ...
      status.appendChild(StatusComponent({
        status: order.status,
        imgSrc: imgUrl
      }));
